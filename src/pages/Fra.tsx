      ...
      <main className="pt-14">
        <div className="relative px-4 pt-6 pb-8 overflow-hidden">
          ...
          <div className="relative flex items-center gap-2">
            ...
            <h1 className="font-heading text-2xl font-bold text-gradient-gold">FRA</h1>
          </div>
          <p className="relative text-xs text-muted-foreground mt-1 ml-7">
            Financial, Regulatory & Account policies
          </p>
        </div>
